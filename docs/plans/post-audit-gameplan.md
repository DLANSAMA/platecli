...
7. **Do not** add Claude-Session or similar trailers to commits/PRs.
...
- [ ] No Claude-Session trailers; no force-push of shared history without ask
...
Constraints: AGENTS.md + SECURITY.md; no --confirm / BAMBU_LIVE without asking; sys.exit only in cli.py; no @mockable; no Claude-Session trailers; do not commit CLAUDE.md.

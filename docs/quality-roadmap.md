...
| Tests | **A−** | **982** non-live tests collected / **980** passing (2026-07-27; the latest additions cover the `plate go` interactive wizard state machine); **84.49%** coverage measured 2026-07-27 on Linux; CI floor **83**; per-module floors not enforced |

...
| Tests | **A−** | **PLACEHOLDER_N** non-live tests collected / **PLACEHOLDER_P** passing (2026-08-05; the Textual TUI phases 1-5 plus the structural refactor wave: layer-boundary enforcement, the Printables adapter's malformed-payload containment sweep, and round-trip tests proving each generated schema matches what its contract emits); **PLACEHOLDER_C** coverage measured 2026-08-05 on Linux; CI floor **83**; per-module floors not enforced |

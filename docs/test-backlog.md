...
|--------|------------------|-----------------|
| Non-live tests collected | **1847** passing (measured 2026-09-22 on Linux; 1 live test deselected) | ≥550 with zero known flakes ✅ size |
...
CI evidence: `.github/workflows/ci.yml` (`--cov-fail-under=90`, blocking ruff/mypy/bandit/pip-audit/purity greps).

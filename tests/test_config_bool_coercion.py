...
@pytest.mark.parametrize("value", [False, "false", "False", "no", "0", "off", "", None, "maybe", 0, 2])
...
@pytest.mark.parametrize("value", [True, "true", "yes", "1", "on", " TRUE ", 1])
...
@pytest.mark.parametrize("value", [False, "false", "no", "0", "off", None, 0])
...
@pytest.mark.parametrize("value", [True, "yes", "true", "maybe", 1, 7])
